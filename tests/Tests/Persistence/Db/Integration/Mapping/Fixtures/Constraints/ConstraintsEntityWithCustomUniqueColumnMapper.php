 ...
 */
class ConstraintsEntityWithCustomUniqueColumnMapper extends EntityMapper
{
    /**
    ...
    protected function define(MapperDefinition $map)
    {
        ...
        $map->column('some_column')->asVarchar(255);
        $map->appendColumnToUniqueIndexes('some_column');
    }
}