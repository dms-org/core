...
class ValueObjectTest extends DbIntegrationTest
{
    ...
    {
        $this->assertInstanceOf(Boolean::class, $this->table->getStructure()->getColumn('has_nullable_money')->getType());
        $this->assertTrue($this->table->getStructure()->getColumn('nullable_cents')->getType()->isNullable());
        $this->assertTrue($this->table->getStructure()->getColumn('nullable_currency')->getType()->isNullable());
    }
